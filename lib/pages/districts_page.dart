 ...
 * @LastEditTime: 2020-09-02 18:00:59
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \weather_app\lib\pages\districts_page.dart
 */
...
class DistrictListPage extends StatelessWidget {
  ...
  DistrictListPage({Key key, this.provinceId, this.cityId, this.name})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    // 数据库数据填充
    Application.db
        .queryAllDistrictsInCity(cityId)
        .then((ds) => _bloc.changeDistricts(ds));
    // 网络数据更新列表并刷新数据库数据
            ...
            child: Scaffold(
              ...
              body: Container(
                ...
                child: StreamBuilder(
                    ...
                    builder: (_, AsyncSnapshot<List<DistrictModel>> snapshot) =>
                                ...
                                itemBuilder: (_, index) => InkWell(
                                    ...
                                    onTap: () {
                                      PreferenceUtils.instance.saveString(
                                          PreferencesKey.WEATHER_CITY_ID,
                                          snapshot.data[index].weatherId);
                                      Application.router.navigateTo(
                                          context,
                                          Routers.generateWeatherRouterPath(
                                              snapshot.data[index].weatherId),
                                          transition:
